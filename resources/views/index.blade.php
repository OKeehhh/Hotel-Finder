...
<head>
 ...
 <meta charset="UTF-8">
    ...
    <link rel="shortcut icon" href="{{ asset('assets/images/FinderLogo1.png') }}" type="image/x-icon">
    ...
    <nav class="navbar navbar-dropdown navbar-fixed-top navbar-expand-lg">
        <div class="container">
            <div class="navbar-brand">
                <img src="assets/images/FinderLogo1.png" alt="Logo" class="logo-image" style="max-width: 100px; height: auto;">
                ...
                <div class="embla__container">
                    ...
                    <div class="embla__slide slider-image item" style="margin-left: 7rem; margin-right: 7rem;">
                        <div class="user">
                            <div class="user_image">
                                <div class="item-wrapper position-relative">
                                    <img src="assets/images/Kim.jpg" alt="Mobirise Website Builder">
                                </div>
                            </div>
                            <div class="user_text mb-4">
                                <p class="mbr-fonts-style display-7">
                            ...
                            <div class="user_name mbr-fonts-style mb-2 display-7">
                                <strong>Eliah Kim Dichoso</strong>
                            </div>
                            <div class="user_desk mbr-fonts-style display-7">
                                DESIGNER
                            </div>
                    ...
                    <div class="embla__slide slider-image item" style="margin-left: 7rem; margin-right: 7rem;">
                        <div class="user">
                            <div class="user_image">
                                <div class="item-wrapper position-relative">
                                    <img src="assets/images/Albrecht.jpg" alt="Mobirise Website Builder">
                                </div>
                            </div>
                            <div class="user_text mb-4">
                                <p class="mbr-fonts-style display-7">
                            ...
                            <div class="user_name mbr-fonts-style mb-2 display-7">
                                <strong>Albrecht Saribay</strong>
                            </div>
                            <div class="user_desk mbr-fonts-style display-7">
                                DESIGNER
                            </div>
                    ...
                    <div class="embla__slide slider-image item" style="margin-left: 7rem; margin-right: 7rem;">
                        <div class="user">
                            <div class="user_image">
                                <div class="item-wrapper position-relative">
                                    <img src="assets/images/Einid.jpg" alt="Mobirise Website Builder">
                                </div>
                            </div>
                            <div class="user_text mb-4">
                                <p class="mbr-fonts-style display-7">
                            ...
                            <div class="user_name mbr-fonts-style mb-2 display-7">
                                <strong>Einid Hope Tandog</strong>
                            </div>
                            <div class="user_desk mbr-fonts-style display-7">
                                DEVELOPER
                            </div>
